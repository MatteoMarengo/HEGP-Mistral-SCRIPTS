...
model_path = "D:/OneDrive/Documents/MVA-ENS-2023-2024/S1/HEGP/HEGP-Mistral-MODELS/GGUF-Mistral7B"
model_file = "mistral-7b-instruct-v0.1.Q5_K_M.gguf"

# Load both the model and the tokenizer from the local directory
model = AutoModelForCausalLM.from_pretrained(model_path, model_file, model_type='mistral')
...
# Generate a response (assuming your model and script are set up fsor generation)
